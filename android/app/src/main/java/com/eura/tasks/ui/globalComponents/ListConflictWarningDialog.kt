package com.eura.tasks.ui.globalComponents
    ...
    AlertDialog(
        ...
        text = {
            Column(modifier = Modifier.fillMaxWidth()) {
                Text("A list with the name \"${localList.title}\" already exists locally but has different settings. Which one do you want to keep? Your tasks in the list will not be affected.")
